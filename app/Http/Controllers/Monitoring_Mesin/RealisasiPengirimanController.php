...
class RealisasiPengirimanController extends Controller
{
    public function json()
    {
        ...
        return DataTables::of($model)
            ...
            ->addColumn('kol-kirim', 'monitoring_mesin.realisasi.kol-kirim')
            ->addColumn('kol-instalasi', 'monitoring_mesin.realisasi.kol-instalasi')
            ->addColumn('action', 'monitoring_mesin.realisasi.action')
            ->rawColumns(['action','kol-kirim','kol-instalasi'])
    ...
    public function index()
    {
        ...
        return view('monitoring_mesin.realisasi.index',compact('customer'));
    }
    ...
    public function updateKirim(Request $request, $id)
    {
        ...
        $header->tgl_kirim = $request->tgl_kirim;
        $header->status = 3;
        ...
        return redirect()->route('monitoringmesin.realisasipengiriman.index')
        ->withSuccess('Realisasi pengiriman '.$header->nomor.' berhasil diupdate');
    }
    ...
    public function updateInstalasi(Request $request, $id)
    {
        ...
        $header->tgl_instalasi = $request->tgl_instalasi;
        $header->status = 3;
        $header->updated_by = $user->id;
        $header->save();
