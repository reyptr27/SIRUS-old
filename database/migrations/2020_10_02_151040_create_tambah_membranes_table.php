...
class CreateTambahMembranesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tam_ba_tambah_membrane', function (Blueprint $table) {
            $table->increments('id');
            $table->string('nomor');
            $table->date('tanggal');
    ...
    {
        Schema::dropIfExists('tam_ba_tambah_membrane');
    }
}
