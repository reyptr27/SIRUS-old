        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table width="100%">
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px"><b>Alasan Pembatalan</b></td>
                        <td valign="top"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $delete_reason }}
                        </td>
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px"><b>Dibatalkan Oleh</b></td>
                        <td valign="top"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $eraser }} ( {{ date('d-m-Y H:i', strtotime($deleted_at)) }} )
                        </td>
                    </tr>
