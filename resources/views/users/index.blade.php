        ...
        $(function() {
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'image', name: 'users.image', orderable: false,searchable: false, className: "text-center"},
                    { data: 'name', name: 'users.name'},
                    { data: 'kode_cabang', name: 'm_cabang.kode_cabang', className: "text-center"},
                    { data: 'kode_departemen', name: 'm_departemen.kode_departemen', className: "text-center"},
                    { data: 'kol-role', name: 'kol-role', orderable: false},
                    { data: 'active', name: 'users.active', className: "text-center"},
