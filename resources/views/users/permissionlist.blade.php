...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">User Permission List</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Permission yang dimiliki User <strong>{{ $user->name }}</strong></h3>
                        ...
                        <div class="modal fade" id="tambahPermission" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('users.permission.add', $user->id) }}" method="post">
                                        {{ csrf_field() }}
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="datatable" width="100%">
                                ...
                                <tbody>
                                    @php $i = 1; @endphp
                                    @forelse($user->permissions as $row)
                                    <tr>
                                    ...
                                    <div class="modal fade" id="hapusPermission{{ $row->id }}" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header text-center">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <h4 class="modal-title" id="myModalLabel">Hapus Permission <strong>{{ $row->name }}</strong> dari <strong>{{ $user->name }}</strong> ?</h4>
                                                </div>
                                                
                                                <form action="{{ route('users.permission.delete', $user->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <div class="modal-footer">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="4" class="text-center">User belum mempunyai permission.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
