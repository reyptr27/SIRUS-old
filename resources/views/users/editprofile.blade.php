            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Update Profile  <strong>{{ $user->name }}</strong></h3>
                    </div>
                    <div class="box-body">
                        <form action="{{ route('profile.update', $user->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <input type="text" name="nik" value="{{ $user->nik }}" class="form-control {{ $errors->has('nik') ? 'is-invalid':'' }}" placeholder="NIK" disabled>
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <input type="text" name="username" value="{{ $user->username }}"class="form-control {{ $errors->has('username') ? 'is-invalid':'' }}" placeholder="Username" disabled>
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <a href="{{ route('profile.password', $user->id) }}" class="btn btn-primary" style="margin-bottom:10px;"> <i class="fa fa-lock"></i> Ganti Password </a>            
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8 col-md-8">
                                <select name="atasan_id" class="form-control {{ $errors->has('atasan_id') ? 'is-invalid':'' }} selectpicker" data-live-search="true" disabled>
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <select name="cabang_id" class="form-control {{ $errors->has('cabang_id') ? 'is-invalid':'' }} selectpicker" data-live-search="true" disabled>
                                ...
                                <div class="col-sm-8 col-md-8">
                                <select name="departemen_id" class="form-control {{ $errors->has('departemen_id') ? 'is-invalid':'' }} selectpicker" data-live-search="true" disabled>
