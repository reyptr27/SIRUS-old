...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('pengadaan.create') }}">Add Pengadaan</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Menambahkan Pengadaan</h3>
                    </div>
                    <div class="box-body">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_id" id="jenis_id" method="POST"
                                    class=" form-control jenis_id" data-live-search="true">
                                ...
                                <div class="col-sm-12"><textarea class="form-control" name="deskripsi" id="deskripsi" cols="60" rows="3" required></textarea></div>
                                <div class="col-sm-12"><label for="">Alasan Permohonan :</label></div>
                                <div class="col-sm-12"><textarea class="form-control" name="akibat" id="akibat" cols="60" rows="3" required></textarea></div>                                 
