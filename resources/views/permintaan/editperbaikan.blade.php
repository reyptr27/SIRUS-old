...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="">Edit Perbaikan</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Mengedit Perbaikan</h3>
                    </div>
                    <div class="box-body">
                        <form action="{{ route('perbaikan.update', $perbaikan->id) }}" 
                        ...
                        {{ method_field('patch') }}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    class="form-control {{ $errors->has('pemohon_id') ? 'is-invalid':'' }}
                                     selectpicker" data-live-search="true" >
                                        ...
                                        <option @if ($pemohon->id == $perbaikan->pemohon_id ) selected @endif
                                ...
                                <div class="col-sm-8">
                                    @foreach($pemohons as $pemohon)
                                        @if ($pemohon->id == $perbaikan->pemohon_id)
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    selectpicker" data-live-search="true">
                                        ...
                                        <option value="Hardware"@if($perbaikan->kode == 'Hardware') selected @endif>Hardware</option>
                                        <option value="Software"@if($perbaikan->kode == 'Software') selected @endif>Software</option>
                                        <option value="Consumables"@if($perbaikan->kode == 'Consumables') selected @endif>Consumables</option>
                                        <option value="Service"@if($perbaikan->kode == 'Service') selected @endif>Service</option>
                                        <option value="Email"@if($perbaikan->kode == 'Email') selected @endif>Email</option>
                                    </select>
                                    <p class="text-danger"></p>   
                                </div>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    class="form-control">
                                        ...
                                        <option @if ($spesifikasi->id == $perbaikan->jenis_id ) selected @endif 
