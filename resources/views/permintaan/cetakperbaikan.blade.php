...
<html>
    <head>
        ...
        <title>{{ $perbaikan->no_document }} </title> 
        <?php
            $login = Auth::user();
        ?>
            ...
            <tbody >
                <tr >
                    ...
                    <td   colspan="2" style="height:100px;">
                        ...
                        <center><b style="text-align:center">Perbaikan Perangkat IT</b></center><br>
                        Edisi : 1<br><br>   
                    ...
                    <td  colspan="2" style="width:220px; height:100px;padding-left:10px;padding-top:10px">
                        ...
                        Nomor Document : F-SRU-ITS-04<br><br>
                ...
                <tr>
                    <td >Tanggal</td>
                    <td colspan="2"> : &nbsp; {{date('d - M - Y', strtotime($perbaikan->created_at))}}</td>
                    <td >No. ID Pemohon </td>
                ...
                <tr>
                    ...
                    <td >Cabang</td>
                    <td colspan="2">: &nbsp;  {{$user->cabang->nama_cabang}}  </td>    
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" valign="top" style="height:80px;">Verifikasi Kerusakan : </td>
                    
                </tr>
                <tr>
                    <td colspan="3" valign="top" style="height:80px;" > 
                    Akibat kerusakan (bila diketahui) : <br>
                    {{ $perbaikan->akibat }}
                     </td>  
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="5" valign="top" >IT Moderator : 
                ...
                <tr>
                    <td colspan="4" rowspan="2" valign="top">Catatan : </td>
                </tr>
                <tr></tr>
                <tr>
                    <td colspan="4">Di bawah ini diisi setelah perbaikan dilakukan.</td>
                    <td colspan="2" rowspan="5" valign="top" >IT Officer : 
                        <br><br><br><br><br><br><br><br>
                        (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="4">Waktu yang dibutuhkan : </td>

                </tr>
                <tr>
                    <td colspan="4">Biaya perbaikan : </td>
                </tr>
                <tr>
                    <td colspan="4">Penanggung jawab kerusakan : 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        [&nbsp;&nbsp;] Perusahaan                        
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td colspan="4" valign="top"> Catatan : </td>
                    <td colspan="2" style="padding-bottom:10px"> Penerima perbaikan : 
                        <br><br><br><br><br><br>
                        (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
