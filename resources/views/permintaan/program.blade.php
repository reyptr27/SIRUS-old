    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                columns: [
                    { data: 'id', name: 'program.id', "visible": false },
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false,searchable: false, className: "text-center"},
                    { data: 'created_at', name: 'program.created_at', className: "text-center" },
                    { data: 'no_document', name: 'program.no_document'},
                    { data: 'pemohon', name: 'pemohon.name'},
                    { data: 'jenis', name: 'program.jenis'},
                    { data: 'program', name: 'program.program'},
                    { data: 'approval', name: 'program.approval'},
