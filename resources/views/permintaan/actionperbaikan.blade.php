<div class="modal fade" id="editstatus{{ $id }}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('perbaikan.updatestatus', $id) }}" method="post">
                {{ csrf_field() }}
                {{ method_field('patch') }}
...
<div class="modal fade" id="detailperbaikan{{ $id }}" role="dialog" aria-labelledby="myModalLabel">                               
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Detail Pengajuan Perbaikan <strong>{{ $no_document }}</strong> ?</h4>
            </div>
...
<a href="{{ route('perbaikan.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href="{{ route('perbaikan.cetak', $id) }}" target="blank" class="btn btn-success btn-xs" title="Cetak"><i class="fa fa-print"></i></a>
...
<div class="modal fade" id="hapusPerbaikan{{ $id }}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('perbaikan.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <div class="modal-footer">
                <center>
