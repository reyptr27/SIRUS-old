<a href="{{ route('surat.eksternal.edit', $id) }}" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
...
<div class="modal fade" id="hapusSurat{{ $id }}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('surat.eksternal.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
