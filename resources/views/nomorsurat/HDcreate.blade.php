...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('surat.hd.create') }}">Tambah Surat Internal HD</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Surat Internal HD</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('surat.hd.store') }}" method="post">
                        {{ csrf_field() }}
