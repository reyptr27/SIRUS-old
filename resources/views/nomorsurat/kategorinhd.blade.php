...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('kategori.nhd.index') }}">Kategori Surat NHD</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Kategori Surat NHD</h3>
                        ...
                        <div class="modal fade" id="tambahKategori" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('kategori.nhd.store') }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <div class="modal fade" id="updateKategori{{ $kategori->id }}" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('kategori.nhd.update', $kategori->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('patch') }}
                                                    <div class="modal-body">
                                    ...
                                    <div class="modal fade" id="hapusKategori{{ $kategori->id }}" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('kategori.nhd.destroy', $kategori->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <div class="modal-footer">
                                                        <center>
