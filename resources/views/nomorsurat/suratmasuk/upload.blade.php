...
?>
<center>
    <a class="btn btn-warning btn-xs" href="{{ route('surat.masuk.show', $id) }}" target="_blank">
    ...
    <a class="btn btn-danger btn-xs" href="{{ route('surat.masuk.download', $id) }}">
...
<div class="modal fade" id="upload{{$id}}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('surat.masuk.upload', $id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
