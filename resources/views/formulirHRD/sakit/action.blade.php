...
<a href="{{ route('hrd.sakit.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href="{{ route('hrd.sakit.print', $id) }}" target="blank" title="Cetak" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title" id="myModalLabel">Detail Formulir Pemberitahuan Sakit tanggal <strong>{{ date('d-m-Y', strtotime($created_at)) }}</strong></h4>
            </div>
            ...
            <div class="modal-body">
                <table width="100%">
                    ...
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>Tanggal Sakit</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
...
<div class="modal fade" id="hapusForm{{ $id }}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <div class="modal-header text-center">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Anda yakin ingin menghapus Form Pemberitahuan Sakit tanggal <strong>{{ date('d-m-Y', strtotime($created_at)) }}</strong> ?</h4>
        </div>
        <form action="{{ route('hrd.sakit.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <div class="modal-footer">
                <center>
