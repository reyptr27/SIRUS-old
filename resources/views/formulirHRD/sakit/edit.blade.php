...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('hrd.izin.edit', $form->id) }}">UpdateFormulir Izin</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Update Formulir Pemberitahuan Sakit</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('hrd.sakit.update', $form->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_masuk" class="form-control" value="{{ $form->tanggal_masuk }}" required>
                            </div>
                        </div>
