...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('hrd.unpaid.create') }}">Tambah Formulir Unpaid Leave</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Formulir Unpaid Leave</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('hrd.unpaid.store') }}" method="post">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="divisi" name="divisi" class="form-control" placeholder="Divisi" required>
                            </div>
                            <div class="form-group">
                                <label for="">Alasan</label>
                                <input type="text" id="alasan" name="alasan" class="form-control" placeholder="Alasan" required>
                            </div>
                            <table width="100%">
                                <tr>
