...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('hrd.unpaid.index') }}">Formulir Unpaid Leave</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Formulir Unpaid Leave</h3>
                        <a href="{{ route('hrd.unpaid.create') }}" class="btn btn-success pull-right">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="datatable" width="100%">
                                <thead>
                                    ...
                                    <th class="text-center">Tgl Unpaid</th>
