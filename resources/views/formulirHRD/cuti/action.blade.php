...
<a href="{{ route('hrd.cuti.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href="{{ route('hrd.cuti.print', $id) }}" target="blank" title="Cetak" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                ...
                <h4 class="modal-title" id="myModalLabel">Detail Formulir Cuti Tanggal <strong>{{ date('d-m-Y', strtotime($created_at)) }}</strong></h4>
            </div>
            ...
            <div class="modal-body">
                <table width="100%">
                    ...
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>Tanggal Bergabung</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
                        <td class="text-left" width="75%" valign="top">{{ date('d-m-Y',strtotime($tanggal_bergabung)) }}</td>
                    </tr>
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>Tanggal Cuti</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
                    ...
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>Alamat Saat Cuti</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
                        <td class="text-left" width="75%" valign="top">{{ $alamat }}</td>
                    </tr>
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>Status Kendaraan</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
                        <td class="text-left" width="75%" valign="top">
                            @if($status_inventaris == 1)
                                Kendaraan dari perusahaan
                            @elseif($status_inventaris == 2)
                                Kendaraan pribadi
                            @elseif($status_inventaris == 3)
                                Tidak mendapatkan inventaris kendaraan
                            @endif
                        </td>
                    </tr>
                    <tr>
                        <td class="text-left" width="20%" height="30px" valign="top"><b>No. Telp/ Handphone</b></td>
                        <td valign="top" width="5%"><b>:</b></td>
                        <td class="text-left" width="75%" valign="top">{{ $no_telp }}</td>
                    </tr>
                    <tr>
...
<div class="modal fade" id="hapusForm{{ $id }}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <div class="modal-header text-center">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Anda yakin ingin menghapus Form Cuti <strong>{{ $id }}</strong> ?</h4>
        </div>
        <form action="{{ route('hrd.cuti.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <div class="modal-footer">
                <center>
