...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href=" {{ route('tambahmembrane.index') }} ">Berita Acara</a></li>
        <li class="active"><a href="{{ route('tambahmembrane.edit', $ba->id) }}">Edit Penambahan Membrane</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Berita Acara Penambahan Membrane</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('tambahmembrane.update', $ba->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="modal-body">
                            ...
                            <br>
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <a href="{{ route('tambahmembrane.index') }}" class="btn btn-danger btn-sm">
