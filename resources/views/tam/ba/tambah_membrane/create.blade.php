...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('tambahmembrane.create') }}">Tambah BA Penambahan Membrane</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Berita Acara Penambahan Membrane</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('tambahmembrane.store')}}" method="post">
                        {{ csrf_field() }}
