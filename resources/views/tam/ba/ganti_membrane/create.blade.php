...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('gantimembrane.create') }}">Tambah BA Penggantian Membrane</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Berita Acara Penggantian Membrane</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('gantimembrane.store')}}" method="post">
                        {{ csrf_field() }}
