...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href=" {{ route('gantimembrane.index') }} ">Berita Acara</a></li>
        <li class="active"><a href="{{ route('gantimembrane.edit', $ba->id) }}">Edit Penggantian Membrane</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Berita Acara Penggantian Membrane</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('gantimembrane.update', $ba->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="modal-body">
                            ...
                            <br>
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <a href="{{ route('gantimembrane.index') }}" class="btn btn-danger btn-sm">
