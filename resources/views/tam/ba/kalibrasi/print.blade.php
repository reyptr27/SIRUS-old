...
<html>
    ...
    <body>
        ...
        <table width="80%" align="center" style="padding-left:0px; padding-right:15px;" 
        border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-left:30px;"
        >
            <tr style="border-collapse:collapse; background-color:#e8e8e8; margin-left:0px;border: 1px solid black;" >
                ...
                <td  width="40%" align="center" style="border: 1px solid black;height:20px">NAMA BARANG</td>
                <td width="30%" align="center" style="border: 1px solid black;"> MERK / TYPE</td>
                <td width="25%" align="center" style="border: 1px solid black;"> NO SERI</td>
            </tr>
            @php $i=1; @endphp
            @foreach ($barang as $brg)
            <tr>
                <td width="5%" align="center" style="border-collapse:collapse;border: 1px solid black;padding-left:15px; padding-right:15px;" > 
                {{$i}}</td>
                <td width="40%" align="center" style="border: 1px solid black;"> MESIN HEMODIALISA </td>
                ...
                <td width="25%" align="center" style="border: 1px solid black;height:20px"> {{$brg->no_seri}} </td>
        ...
        <table width=100% style="font-size:16px; margin-left:-5px;margin-right:0px; margin-top:-25px; border-collapse:collapse; padding-left:10px;">
            ...
            <tr>
                <td width="20%"  align="center"style="border: 1px solid black;"><u>{{$ba->katam}}</u> <br> KA. TAM Area</td>
