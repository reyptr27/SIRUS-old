...
<a href="{{ route('gantimedia.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href=" {{ route('gantimedia.print',$id) }} " target="blank" title="Cetak" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
...
<div class="modal fade" id="hapusBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('gantimedia.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
...
<div class="modal fade" id="lihatBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">                               
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Detail Berita Acara Penggantian Media Pre-Treatment <br> Nomor <strong>{{$nomor}}</strong></h4>
            </div>
            ...
            <div class="modal-body">
                <table width="100%"  style="border:1px">
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Jumlah Carbon Active</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $jumlah_carbon }}
                        </td>                                                                 
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Jumlah Resin Cation</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $jumlah_resin }}
                        </td>                                                                 
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Jumlah Sand Filter</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $jumlah_sand }}
                        </td>                                                                 
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Jumlah Pyrolox</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $jumlah_pyrolox }}
                        </td>                                                                 
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Keterangan</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $keterangan }}
                        </td>                                                                 
