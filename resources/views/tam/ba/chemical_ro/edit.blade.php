...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href=" {{route('chemical_ro.index')}} ">Berita Acara</a></li>
        <li class="active"><a href="{{ route('chemical_ro.edit', $ba->id) }}">Edit Chemical RO</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Berita Acara Chemical RO</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('chemical_ro.update', $ba->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
