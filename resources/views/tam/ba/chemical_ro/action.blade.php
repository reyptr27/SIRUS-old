<?php 
    ...
    use App\Models\TAM\BA\Chemical_RO;
    use App\User;
...
<a href="{{ route('chemical_ro.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href=" {{ route('chemical_ro.print',$id) }} " target="blank" title="Cetak" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
...
<div class="modal fade" id="hapusBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('chemical_ro.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
...
<div class="modal fade" id="lihatBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">                               
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Detail Berita Acara Chemical RO Nomor <strong>{{$nomor}}</strong></h4>
            </div>
