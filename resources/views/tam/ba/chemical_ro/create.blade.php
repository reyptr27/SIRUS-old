...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('chemical_ro.create') }}">Tambah BA Chemical RO</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Berita Acara Chemical RO</h3>
                    </div>
                    <div class="box-body">
                    <form action="{{ route('chemical_ro.store')}}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    id="jenis_pekerjaan" cols="60" rows="3" required>Chemical RO untuk</textarea>
                                </div>                                 
                            ...
                            <br>
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <a href="{{ route('chemical_ro.index') }}" class="btn btn-danger btn-sm">
