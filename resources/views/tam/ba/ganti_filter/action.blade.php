...
<a href="{{ route('gantifilter.edit', $id) }}" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
<a href=" {{ route('gantifilter.print',$id) }} " target="blank" title="Cetak" class="btn btn-success btn-xs"><i class="fa fa-print"></i></a>
...
<div class="modal fade" id="hapusBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        ...
        <form action="{{ route('gantifilter.destroy', $id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
...
<div class="modal fade" id="lihatBa{{$id}}" role="dialog" aria-labelledby="myModalLabel">                               
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Detail Berita Acara Penggantian Filter Endotoxin Nomor <strong>{{$nomor}}</strong></h4>
            </div>
            ...
            <div class="modal-body">
                <table width="100%"  style="border:1px">
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Nama Barang</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $nama_barang }}
                        </td>                                                                 
                    ...
                    <tr>
                        <td valign="top" class="text-left" height="30px" width="30%"><b>Jumlah Barang</b></td>
                        <td valign="top" width="3%"><b>:</b></td>
                        <td valign="top" class="text-left">
                            {{ $jumlah }}
                        </td>                                                                 
