...
<html>
    ...
    <body>
        ...
        <p style="font-size:16px; text-align:left; margin-left:20px; margin-right:20px" >
            ...
            dengan ini telah dilakukan penggantian Filter Endotoxin dari <b>PT. SINAR RODA UTAMA</b> (Pihak Pertama)
        ...
        <table width="95%" align="center" style="padding-left:0px">
            ...
            <tr>
                ...
                <td align="center"> Filter Endotoxin <br> ({{$ba->nama_barang}}) </td>
                <td align="center"> {{$ba->jumlah}} Pcs </td>
