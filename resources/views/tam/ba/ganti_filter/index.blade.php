...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">BA Penggantian Filter Endotoxin</a></li>
        <li class="active"><a href="{{ route('gantifilter.index') }}">List Berita Acara</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Berita Acara Penggantian Filter Endotoxin</h3>
                        <a href="{{ route('gantifilter.create') }}" class="btn btn-success pull-right">
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('gantifilter.json') }}',
                columns: [
                    { data: 'id', name: 'tam_ba_ganti_filter.id', "visible": false },
                    { data: 'DT_RowIndex', name: 'DT_RowIndex',  orderable: false,searchable: false, className: "text-center"},
                    { data: 'nomor', name: 'tam_ba_ganti_filter.nomor'},
                    { data: 'tanggal', name: 'tam_ba_ganti_filter.tanggal'},
