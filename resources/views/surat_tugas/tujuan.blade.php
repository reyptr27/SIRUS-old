...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('surattugas.tujuan') }}">List Tujuan</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Tujuan</h3>
                        ...
                        <div class="modal fade" id="tambahTujuan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('surattugas.tujuan.store') }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <div class="modal fade" id="updateTujuan{{ $tujuan->id }}" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('surattugas.tujuan.update', $tujuan->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('patch') }}
                                                    <div class="modal-body">
                                    ...
                                    <div class="modal fade" id="hapusTujuan{{ $tujuan->id }}" role="dialog" aria-labelledby="myModalLabel">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('surattugas.tujuan.destroy', $tujuan->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <div class="modal-footer">
                                                        <center>
