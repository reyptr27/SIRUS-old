...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('surattugas.index') }}">List Surat Tugas</a></li>
    </ol>
    </section>  
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Surat Tugas</h3>
        ...
        $(function() {
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'kol-approval', name: 'kol-approval', className: "text-center"},
